...
/**
 * Objetivo: Dar de alta un kiosco de manera exitosa que corresponda a un Canal Virtual.
 */
test.describe('MOD-ORG-KIO-TC-01 | Alta de Kiosco – Canal Virtual', () => {
  ...
  test('Crear kiosco como canal virtual exitosamente', async ({ paginaKioscos, page }) => {
    const nombre = `AUTO_KIO_VIRTUAL_${Date.now()}`;
